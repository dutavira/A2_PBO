...
public class Main {
    ...
    static void tampil_ekonomi(){
        ...
        for(int i = 0 ; i < tiket_ekonomi.size();i++){
            ...
            System.out.println("| Nama    : "+ tiket_ekonomi.get(i).getNama());
            System.out.println("| Asal    : "+ tiket_ekonomi.get(i).getAsal());
            System.out.println("| Tujuan  : "+ tiket_ekonomi.get(i).getTujuan());
            System.out.println("| Harga   : "+ tiket_ekonomi.get(i).getHarga() + " Rupiah");
            System.out.println("| Tanggal : "+ tiket_ekonomi.get(i).getTanggal());
            System.out.println("*================================*");
            
            //memanggil method overloading
            Tiket_Pesawat tiket = new Tiket_Pesawat(asal, tujuan, nama, harga, tanggal);
            tiket.overloading(" Ekonomi");
            Ekonomi t_ekonomi = new Ekonomi(asal, tujuan, nama, harga, tanggal);
            t_ekonomi.overloading(0);
        }
    ...
    static void tampil_bisnis(){
        ...
        for(int i = 0 ; i < tiket_bisnis.size();i++){
            System.out.println("*================================*");
            System.out.println("| Nomor   : ["+(i+1)+"]");
            System.out.println("| Nama    : "+ tiket_bisnis.get(i).getNama());
            System.out.println("| Asal    : "+ tiket_bisnis.get(i).getAsal());
            System.out.println("| Tujuan  : "+ tiket_bisnis.get(i).getTujuan());
            System.out.println("| Harga   : "+ tiket_bisnis.get(i).getHarga() + " Rupiah");
            System.out.println("| Tanggal : "+ tiket_bisnis.get(i).getTanggal());
            System.out.println("*================================*");
            
            //memanggil method overloading
            Tiket_Pesawat tiket = new Tiket_Pesawat(asal, tujuan, nama, harga, tanggal);
            tiket.overloading(" Bisnis");
            Bisnis t_bisnis = new Bisnis(asal, tujuan, nama, harga, tanggal);
            t_bisnis.overloading(0);
        }
